...
export default function Products(props) {
    ...
    return (
        <>
            ...
            {/* <div>
                <section class="blog" id="blog" style={{ backgroundAttachment: "fixed", backgroundImage: "url(images/client-logo/products_.jpg)", backgroundRepeat: "no-repeat", backgroundSize: "100vw 100vh", width: "100vw" }}>
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="title text-center ">
                                    <h2><span class="color" style={{ color: "white" }}>Ürünler</span></h2>
