              ...
              <ul className="navbar-nav ml-auto text-center">
                ...
                {props.loginStatus && (
                  <li className="nav-item dropdown">
                    ...
                    >
                      <a
                        className="dropdown-item"
                        onClick={() => props.setActivePage("AddProduct")}
                      >
                        Ürün Ekle
                      </a>
                      <a
                        className="dropdown-item"
                        onClick={() => props.setActivePage("DeleteProduct")}
                      >
                        Ürün Sil
                      </a>
                    </div>
                ...
                {props.loginStatus && (
                  <li className="nav-item dropdown">
                    ...
                    >
                      <a
                        className="dropdown-item"
                        onClick={() => props.setActivePage("AddCategory")}
                      >
                        Kategori Ekle
                      </a>
                      <a
                        className="dropdown-item"
                        onClick={() => props.setActivePage("DeleteCategory")}
                      >
                        Kategori Sil
                      </a>
                    </div>
                ...
                {props.loginStatus && (
                  <li className="nav-item ">
                    <a
                      className="nav-link"
                      onClick={() => props.setLoginStatus(false)}
                    >
                      Çıkış Yap
                    </a>
                  </li>
